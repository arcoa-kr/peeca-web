    ...
    <footer className="border-t border-(--color-line) bg-white pt-8 pb-10 px-5 sm:px-10 sm:pt-12 sm:pb-18">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between gap-12">
        ...
        <div className="flex flex-col order-2 md:order-1">
          ...
          <p className="pt-7 text-sm text-(--color-text-3)">© 2026 peeca by <a href="https://arcoa.kr" target="_blank" rel="noopener noreferrer"><span className="font-medium text-(--color-text-2)"><u>ARCOA</u></span></a></p>
        </div>
